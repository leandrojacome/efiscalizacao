...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="overview-wrap">
                <h2 class="title-1">Papeis</h2>
                <a class="au-btn au-btn-icon au-btn--blue" href="{{route('papel.create')}}">
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{url('/papel/buscar')}}" method="post" class="form-horizontal">
                @csrf
                ...
                <table class="table table-borderless table-striped table-earning">
                    ...
                    @if(!is_null($papeis))
                        @foreach($papeis as $papel)
                            <tr>
                                <td><a href="{{ route('papel.show', $papel->id) }}">{{ $papel->slug }}</a>
                                </td>
                                <td class="text-right">
                                    <a href="{{ route('papel.edit', $papel->id) }}"
